...
def test_render():
    ...
    test_gui.video_path = '~/Desktop/SampleVideo_1280x720_1mb.mp4'
    ...
    check.equal(test_gui.video_path, '~/Desktop/SampleVideo_1280x720_1mb.mp4')
    check.equal(test_gui.settings, {'conf': .5, 'poll': 3, 'anti': 1, 'search': [
        "child"], 'path': '~/Desktop/SampleVideo_1280x720_1mb.mp4'})
