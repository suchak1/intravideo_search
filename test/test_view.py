...
def test_set_settings():
    ...
    check.is_true(view.set_settings(set3, path)[0])
    check.is_false(view.set_settings(set3, notapath)[0])

    check.is_false(view.set_settings(set4, path)[0])
    check.is_false(view.set_settings(set4, notapath)[0])

    check.is_true(view.set_settings(set5, path)[0])
    check.is_false(view.set_settings(set5, notapath)[0])

    check.is_false(view.set_settings(set6, path)[0])
    check.is_false(view.set_settings(set6, notapath)[0])
    ...
    check.is_true(view.set_settings(set11, path)[0])
    check.is_false(view.set_settings(set11, notapath)[0])

    check.is_false(view.set_settings(set12, path)[0])
    check.is_false(view.set_settings(set12, notapath)[0])

    check.is_true(view.set_settings(set13, path)[0])
    check.is_false(view.set_settings(set13, notapath)[0])

    check.is_false(view.set_settings(set14, path)[0])
    check.is_false(view.set_settings(set14, notapath)[0])

    check.is_true(view.set_settings(set15, path)[0])
    check.is_false(view.set_settings(set15, notapath)[0])

    check.is_false(view.set_settings(set16, path)[0])
    check.is_false(view.set_settings(set16, notapath)[0])

    check.is_false(view.set_settings(set17, path)[0])
    check.is_false(view.set_settings(set17, notapath)[0])

    check.is_true(view.set_settings(set18, path)[0])
    check.is_false(view.set_settings(set18, notapath)[0])

    check.is_false(view.set_settings(set19, path)[0])
    check.is_false(view.set_settings(set19, notapath)[0])

    check.is_false(view.set_settings(set20, path)[0])
    check.is_false(view.set_settings(set20, notapath)[0])

    check.is_false(view.set_settings(set21, path)[0])
    check.is_false(view.set_settings(set21, notapath)[0])

    check.is_false(view.set_settings(set22, path)[0])
    check.is_false(view.set_settings(set22, notapath)[0])

    check.is_false(view.set_settings(set23, path)[0])
    check.is_false(view.set_settings(set23, notapath)[0])

    check.is_false(view.set_settings(set24, path)[0])
    check.is_false(view.set_settings(set24, notapath)[0])
...
def test_get_settings():
    ...
    d11 = {"video": './test/sampleVideo/SampleVideo_1280x720_1mb.mp4',
           "settings": set11}
    ...
    d13 = {"video": './test/sampleVideo/SampleVideo_1280x720_1mb.mp4',
           "settings": set13}
    ...
    d15 = {"video": './test/sampleVideo/SampleVideo_1280x720_1mb.mp4',
           "settings": set15}
    ...
    d18 = {"video": './test/sampleVideo/SampleVideo_1280x720_1mb.mp4',
           "settings": set18}
...
def test_render():
    ...
    test_gui.set_settings({'conf': .5, 'poll': 3, 'anti': 1,
                           'runtime': 10, 'search': ['child']}, test_gui.video_path)

    # assert that these changes have gone through
    check.equal(test_gui.video_path,
                './test/sampleVideo/SampleVideo_1280x720_1mb.mp4')
    check.equal(test_gui.get_settings(), {'settings': {'conf': .5, 'poll': 3, 'anti': 1, 'runtime': 10, 'search': [
                'child']}, 'video': './test/sampleVideo/SampleVideo_1280x720_1mb.mp4'})
    check.is_none(test_gui.job)
    ...
    check.equal(test_gui.settings, {
                'conf': 0.2, 'poll': 1, 'anti': 1, 'runtime': 10, 'search': ["child, kid, ball"]})
    #check.equal(test_gui.job, test_job1)
    ...
    test_gui.set_settings({'conf': 0.2, 'poll': 1, 'anti': 1,
                           'runtime': 10, 'search': ["child, kid, ball"]}, 2)
    ...
    test_gui3.settings = {'conf': .73, 'poll': 93,
                          'anti': 146, 'runtime': 10, 'search': ['boy']}
    ...
    check.equal(test_gui3.settings, {
                'conf': .73, 'poll': 93, 'anti': 146, 'runtime': 10, 'search': ['boy']})
